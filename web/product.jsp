<%-- 
    Document   : product
    Description: Displays table of all products
...
<table border="10" style="width:100%">
    ...
    <center>
        <font size="5px" style="font-weight:bold;vertical-align:top;color:white;">All Products</font>
    </center>
</td>
</tr>
<tr>
...
<!-- Nulls search attribute for CartAddToServlet -->
